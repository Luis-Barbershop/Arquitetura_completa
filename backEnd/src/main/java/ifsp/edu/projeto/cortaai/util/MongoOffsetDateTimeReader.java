package ifsp.edu.projeto.cortaai.util;

import static ifsp.edu.projeto.cortaai.util.MongoOffsetDateTimeWriter.DATE_FIELD;
import static ifsp.edu.projeto.cortaai.util.MongoOffsetDateTimeWriter.OFFSET_FIELD;
