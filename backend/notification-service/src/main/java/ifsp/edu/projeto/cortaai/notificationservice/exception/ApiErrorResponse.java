...
public class ApiErrorResponse {
    ...
    @Schema(description = "Mensagem legível explicando o erro", example = "Notificação não encontrada.")
    private final String message;

    @Schema(description = "Classe da exceção que originou o erro", example = "NotFoundException")
    private final String cause;

    @Schema(description = "Microserviço que gerou o erro", example = "notification-service")
    private final String origin;

    @Schema(description = "URI que causou o erro", example = "/api/notifications/123/read")
    ...
    public record FieldError(
            @Schema(description = "Nome do campo", example = "userId") String field,
