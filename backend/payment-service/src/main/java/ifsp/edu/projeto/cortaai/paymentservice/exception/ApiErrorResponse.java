...
public class ApiErrorResponse {
    ...
    @Schema(description = "Razão HTTP (ex: Bad Request)", example = "Bad Request")
    private final String error;

    @Schema(description = "Mensagem legível explicando o erro", example = "Agendamento não encontrado para pagamento.")
    private final String message;

    @Schema(description = "Classe da exceção que originou o erro", example = "IllegalArgumentException")
    private final String cause;

    @Schema(description = "Microserviço que gerou o erro", example = "payment-service")
    private final String origin;

    @Schema(description = "URI que causou o erro", example = "/api/payments/create")
    ...
    public record FieldError(
            @Schema(description = "Nome do campo", example = "appointmentId") String field,
            @Schema(description = "Mensagem de erro do campo", example = "não pode ser nulo") String message
    ) {}
}
