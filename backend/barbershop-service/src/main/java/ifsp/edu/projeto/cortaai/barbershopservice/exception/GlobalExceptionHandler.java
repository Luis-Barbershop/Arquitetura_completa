...
/**
 * Handler global de exceções do barbershop-service.
 * <p>
...
public class GlobalExceptionHandler {
    ...
    @Value("${spring.application.name:barbershop-service}")
    ...
    public ResponseEntity<ApiErrorResponse> handleForbidden(ForbiddenException ex, HttpServletRequest request) {
        log.warn("Acesso proibido: {} em {}", ex.getMessage(), request.getRequestURI());
    ...
    public ResponseEntity<ApiErrorResponse> handleDomainConflict(DomainConflictException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiErrorResponse> handleUserServiceUnavailable(UserServiceUnavailableException ex, HttpServletRequest request) {
        log.error("user-service indisponível: {}", ex.getMessage());
    ...
    private String extractConstraintMessage(DataIntegrityViolationException ex) {
        ...
        if (rootMessage.contains("Duplicate entry")) {
            if (rootMessage.contains("cnpj"))  return "Este CNPJ já está cadastrado.";
