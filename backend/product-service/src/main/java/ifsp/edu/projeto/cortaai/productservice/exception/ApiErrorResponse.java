...
public class ApiErrorResponse {
    ...
    @Schema(description = "Mensagem legível explicando o erro", example = "Produto não encontrado.")
    private final String message;

    @Schema(description = "Classe da exceção que originou o erro", example = "NotFoundException")
    private final String cause;

    @Schema(description = "Microserviço que gerou o erro", example = "product-service")
    private final String origin;

    @Schema(description = "URI que causou o erro", example = "/api/products/123")
    ...
    public record FieldError(
            @Schema(description = "Nome do campo", example = "name") String field,
            @Schema(description = "Mensagem de erro do campo", example = "não pode ser vazio") String message
    ) {}
}
