...
public class AppointmentsService {
    ...
    public void on(final BeforeDeleteBarber event) {
        final ReferenceException referenceException = new ReferenceException();
        final Appointments barberAppointments = appointmentsRepository.findFirstByBarberId(event.getId());
        if (barberAppointments != null) {
            referenceException.setKey("barber.appointments.barber.referenced");
            referenceException.addParam(barberAppointments.getId());
    ...
    public void on(final BeforeDeleteCustomer event) {
        ...
        if (customerAppointments != null) {
            referenceException.setKey("customer.appointments.customer.referenced");
            referenceException.addParam(customerAppointments.getId());
            throw referenceException;
        }
    }
