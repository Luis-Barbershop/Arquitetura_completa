...
public @interface BarberDocumentCPFUnique {
    ...
    class BarberDocumentCPFUniqueValidator implements ConstraintValidator<BarberDocumentCPFUnique, String> {
        ...
        public BarberDocumentCPFUniqueValidator(final BarberService barberService,
        ...
        public boolean isValid(final String value, final ConstraintValidatorContext cvContext) {
            ...
            if (currentId != null && value.equalsIgnoreCase(barberService.get(UUID.fromString(currentId)).getDocumentCPF())) {
                // value hasn't changed
                return true;
            }
            return !barberService.documentCPFExists(value);
        }
