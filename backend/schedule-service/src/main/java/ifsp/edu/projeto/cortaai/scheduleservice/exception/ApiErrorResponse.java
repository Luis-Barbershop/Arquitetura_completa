...
public class ApiErrorResponse {
    ...
    @Schema(description = "Mensagem legível explicando o erro", example = "Agendamento não encontrado.")
    private final String message;

    @Schema(description = "Classe da exceção que originou o erro", example = "NotFoundException")
    private final String cause;

    @Schema(description = "Microserviço que gerou o erro", example = "schedule-service")
    private final String origin;

    @Schema(description = "URI que causou o erro", example = "/api/appointments/123")
    ...
    public record FieldError(
            @Schema(description = "Nome do campo", example = "barberId") String field,
