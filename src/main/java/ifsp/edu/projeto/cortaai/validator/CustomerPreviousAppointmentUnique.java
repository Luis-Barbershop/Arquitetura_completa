...
public @interface CustomerPreviousAppointmentUnique {
    ...
    class CustomerPreviousAppointmentUniqueValidator implements ConstraintValidator<CustomerPreviousAppointmentUnique, String> {
        ...
        public CustomerPreviousAppointmentUniqueValidator(final CustomerServiceImpl customerServiceImpl,
        ...
        public boolean isValid(final String value, final ConstraintValidatorContext cvContext) {
            ...
            if (currentId != null && value.equalsIgnoreCase(customerServiceImpl.get(UUID.fromString(currentId)).getPreviousAppointment())) {
                // value hasn't changed
                return true;
            }
            return !customerServiceImpl.previousAppointmentExists(value);
        }
